...
<div class="container">
  <div class="row">
    <div class="col-12">
      <table class="table text-center align-baseline">
          <thead>
            <tr>
              <th colspan="4"><h4>Liste des stagiaires</h4></th>
            </tr>
            <tr>
                ...
                if($_GET["coSec"] == $values["codSec"]){
                    ...
                    echo '  
                        <tr>
                            ...
                            <td>'.$values["nomSta"].'</td>
                            <td>'.$values["preSta"].'</td>
                            <td><img src="models/assets/'.$_GET["coSec"].'_'.$values["codSta"].'.png" width=70px; height=70px; alt="photo"></td>
                            <td class="align-baseline"><a href="./index.php?act=fi&coSec='.$values["codSec"].'&coSta='.$values["codSta"].'">
                    ...
                    echo ' <h4>Pas de stagiaire dans cette section </h4>';
                } ?>
          </tbody>
      </table>
      </div >
      <div class="text-center">
        <?php if(isset($msgStagVide)){echo $msgStagVide;}?>
      </div>
    </div>
  <!-- /.row -->
</div>
